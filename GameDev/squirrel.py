...
WINHEIGHT = 480 #REQUIREMENT No.1
...
CAMERASLACK = 90
CAMERASLACK_X=90#REQUIREMENT No.2
CAMERASLACK_Y=70#REQUIREMENT No.2
    ...
    while True: # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            if random.randint(0, 99) < DIRCHANGEFREQ:
                ...
                sObj['movey'] = abs(getRandomVelocity())#REQUIREMENT No.3
        ...
        if (camerax + HALF_WINWIDTH) - playerCenterx > CAMERASLACK_X:#REQUIREMENT No.2
            camerax = playerCenterx + CAMERASLACK_X - HALF_WINWIDTH#REQUIREMENT No.2
        elif playerCenterx - (camerax + HALF_WINWIDTH) > CAMERASLACK_X:#REQUIREMENT No.2
            camerax = playerCenterx - CAMERASLACK_X - HALF_WINWIDTH#REQUIREMENT No.2
        if (cameray + HALF_WINHEIGHT) - playerCentery > CAMERASLACK_Y:#REQUIREMENT No.2
            cameray = playerCentery + CAMERASLACK_Y - HALF_WINHEIGHT#REQUIREMENT No.2
        elif playerCentery - (cameray + HALF_WINHEIGHT) > CAMERASLACK_Y:#REQUIREMENT No.2
            cameray = playerCentery - CAMERASLACK_Y - HALF_WINHEIGHT#REQUIREMENT No.2
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        playerObj['size'] -= int( (sqObj['width'] * sqObj['height'])**0.2 ) - 1#REQUIREMENT No.4
                        del squirrelObjs[i]
                        ...
                        if playerObj['size'] < WINSIZE:#REQUIREMENT No.4
...
def makeNewSquirrel(camerax, cameray):
    ...
    sq['movey'] = abs(getRandomVelocity())#REQUIREMENT No.3
